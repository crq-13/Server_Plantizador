...
origins = ["*"]
URL_GET_PLANTIZADOR = 'https://os55bfy18f.execute-api.us-east-2.amazonaws.com/dev/getPlantizacion'
URL_POST_PLANTIZADOR = 'https://os55bfy18f.execute-api.us-east-2.amazonaws.com/dev/postPlantizacion'
